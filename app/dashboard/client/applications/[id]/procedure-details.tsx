...
export default function ProcedureDetails({ procedure }: ProcedureDetailsProps) {
    ...
    const handleUpload = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            // Step 1: Upload the actual file to disk via API route
            ...
            if (!uploadRes.ok || uploadData.error) {
                alert(uploadData.error || "File upload failed. Please try again.");
                setUploading(false);
                return;
            }

            // Step 2: Pass the real URL to the server action to save in DB
            ...
            serverFormData.append("fileUrl", uploadData.url);
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-3 mt-1">
                                                    ...
                                                    <span className={`text-[9px] font-black uppercase tracking-widest flex items-center gap-1 ${
                                                        doc.status === "VERIFIED" ? "text-green-500" : "text-blue-500"
                                                    }`}>
                                        ...
                                        <div className="relative group/zone">
                                            ...
                                            <div className="flex flex-col items-center justify-center gap-4 p-8 border-2 border-dashed border-blue-100 rounded-3xl bg-blue-50/20 group-hover/zone:bg-blue-50/50 group-hover/zone:border-blue-400 transition-all duration-500">
                                                ...
                                                <div className="text-center">
                                                    {selectedFileName ? (
                                                        <>
                                                            <p className="text-xs font-black text-green-700 uppercase tracking-tight line-clamp-1 max-w-[200px]">{selectedFileName}</p>
