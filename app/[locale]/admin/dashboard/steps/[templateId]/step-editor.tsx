...
export default function StepEditor({
    ...
    const [deleteSubStep, setDeleteSubStep] = useState<{
        stepIndex: number;
        subIndex: number;
    } | null>(null);
    ...
    function confirmRemoveStep() {
        ...
        setSteps((prev) =>
            prev.filter((_, i) => i !== deleteStepIndex)
        );
    ...
    function addRequiredDocument(stepIndex: number, name: string) {
        ...
        setSteps((prev) =>
            prev.map((s, i) =>
                i === stepIndex &&
                !s.requiredDocuments.includes(trimmed)
                    ? {
                          ...s,
                          requiredDocuments: [
                              ...s.requiredDocuments,
    ...
    function requestRemoveRequiredDocument(
        stepIndex: number,
        docIndex: number
    ) {
    ...
    function commitSubStepOnEnter(
        stepIndex: number,
        subIndex: number
    ) {
        const current =
            steps[stepIndex]?.subSteps[subIndex];
    ...
    function commitDocumentOnEnter(
        stepIndex: number,
        value: string,
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-3">
                {steps.map((step, index) => {
                    /*
                     * For built-in steps:
                     * - if label exists, it is a custom override
                     * - if label is empty, display the translated system label
                     *
                     * Example:
                     * FR -> Inscription
                     * EN -> Registration
                        ...
                        >
                            <div className="flex flex-col items-center gap-1 pt-1 shrink-0">
                                <button
                                    ...
                                    className="p-1 text-gray-400 hover:text-[#1E3A8A] disabled:opacity-20"
                                    title={t("moveUp")}
                                >
                            ...
                            <div className="flex-1 space-y-2 min-w-0">
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        className="p-1.5 text-gray-300 hover:text-red-600 shrink-0"
                                        title={t(
                                            "deleteStepTooltip"
                                        )}
                                    >
                                        ...
                                        {step.requiredDocuments.map(
                                            (
                                                ...
                                                <span
                                                    ...
                                                    className="inline-flex items-center gap-1 bg-blue-50 border border-blue-100 text-blue-700 text-xs font-bold px-2.5 py-1 rounded-full"
                                                >
                                                    {doc}
                                            ...
                                            >
                                                <div className="flex flex-col shrink-0">
                                                    <button
                                                        ...
                                                        className="text-gray-300 hover:text-[#1E3A8A] disabled:opacity-20"
                                                    >
