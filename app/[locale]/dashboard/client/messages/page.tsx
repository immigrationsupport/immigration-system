    ...
    return (
        <div className="space-y-8 max-w-5xl mx-auto px-4 py-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-black text-gray-900 tracking-tight" style={{ color: "#1E3A8A" }}>{t("officialNotifications")}</h1>
                ...
                <div className="bg-blue-50 px-4 py-2 rounded-lg border border-blue-100 flex items-center gap-2">
                    ...
                    <span className="text-sm font-bold text-[#1E3A8A]">{messages.length} {t("messages")}</span>
                </div>
            </div>
            ...
            <div className="space-y-4">
                {messages.length > 0 ? (
                    ...
                    <div className="py-24 flex flex-col items-center justify-center text-center bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200">
                        ...
                        <h3 className="text-lg font-black text-gray-900">{t("inboxClear")}</h3>
                        <p className="text-gray-500 text-sm max-w-xs mx-auto mt-2">{t("noMessagesDesc")}</p>
                    </div>
                )}
            </div>
            ...
            <div className="bg-amber-50 border border-amber-200 p-4 rounded-xl flex gap-4 items-start">
                ...
                <div>
                    <h4 className="text-sm font-black text-amber-900 uppercase tracking-tight">{t("professionalNotice")}</h4>
