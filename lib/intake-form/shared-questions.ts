...
export const academicQuestions: Question[] = [
    {
        ...
        required: true,
        options: [
            { value: "NONE", label: "BEPC / GCE Ordinary Level (sans diplôme)" },
            { value: "BAC", label: "Baccalauréat / GCE Advanced Level" },
            { value: "BTS", label: "BTS / HND" },
            { value: "LICENCE", label: "Licence / Bachelor's Degree" },
