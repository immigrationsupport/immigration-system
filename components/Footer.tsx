                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 border-b border-gray-200 pb-8">
                    <div>
                        ...
                        <p className="text-gray-600 text-sm max-w-sm leading-relaxed">
                            Professional immigration consultancy delivering secure, transparent, and accurate visa and residency processing globally.
                        </p>
                    </div>
